...
def setup_model():
    """Sets up a model for training or testing."""
    # Build the model
...
def __main__():
    ...
    if cfg.TEST.WEIGHTS == "":
        ...
        test_model(model, cfg.TEST.DATA_DIR, cfg.TEST.DATASET_LIST, cfg.TEST.SCALE_LIST, cfg.SupG.rerank, cfg.SupG.gemp, cfg.SupG.rgem, cfg.SupG.sgem, cfg.SupG.onemeval, cfg.MODEL.DEPTH, cfg.IMGS_PER_QUERY)
